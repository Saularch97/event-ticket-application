...
docker_build('event-ticket-application_payment', './paymentprocessor')
...
k8s_resource(workload='payment-processor-deployment', new_name='payment', port_forwards='8083')

k8s_resource(workload='postgres-deployment', new_name='postgres')
